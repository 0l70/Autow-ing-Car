  ...
  return (
    <div className="h-full flex flex-col gap-4 min-h-0">
        ...
        <div className="glass-panel rounded-xl p-5 flex-1 flex flex-col min-h-0 border-accent-lime/30 shadow-[0_0_15px_rgba(0,255,0,0.1)] relative">
            ...
            <div className="text-[10px] text-gray-500 font-mono mb-2 opacity-50 overflow-hidden text-ellipsis whitespace-nowrap">
                [Source: /sub/telemetry/&#123;vehicleId&#125;] • Fields: speed, heading, position
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
                ...
                <div className="relative p-3 rounded-xl border border-gray-600/50 bg-[hsl(var(--bg-tertiary)_/_0.3)] overflow-hidden">
                    <div className="flex items-center gap-2 text-gray-500 mb-1">
                        ...
                        <span className="text-xs font-bold tracking-wider uppercase">SPEED</span>
                    </div>
                    <div className="flex items-baseline gap-1">
                        <span className="text-4xl font-mono font-bold text-accent-orange drop-shadow-[0_0_8px_rgba(255,120,0,0.4)]">18.5</span>
                        <span className="text-sm text-gray-500 font-bold">km/h</span>
                    </div>
                </div>
                ...
                <div className="relative p-3 rounded-xl border border-gray-600/50 bg-[hsl(var(--bg-tertiary)_/_0.3)] overflow-hidden">
                    <div className="flex items-center gap-2 text-gray-500 mb-1">
                        ...
                        <span className="text-xs font-bold tracking-wider uppercase">HEADING</span>
                    </div>
                    <div className="flex items-baseline gap-1">
                        <span className="text-4xl font-mono font-bold text-accent-cyan drop-shadow-[0_0_8px_rgba(0,255,255,0.4)]">87</span>
            ...
            <div className="grid grid-cols-2 gap-3 flex-1">
                 {/* POS X */}
                 <div className="relative p-3 rounded-xl border border-gray-600/30 bg-[hsl(var(--bg-tertiary)_/_0.2)] flex flex-col justify-end">
                    <div className="flex items-center gap-2 text-gray-600 mb-auto">
                        <span className="text-[10px] font-bold tracking-wider uppercase">POSITION X</span>
                    </div>
                ...
                <div className="relative p-3 rounded-xl border border-gray-600/30 bg-[hsl(var(--bg-tertiary)_/_0.2)] flex flex-col justify-end">
                    <div className="flex items-center gap-2 text-gray-600 mb-auto">
                        <span className="text-[10px] font-bold tracking-wider uppercase">POSITION Y</span>
                    </div>
                    <div className="text-xl font-mono text-white/80">
                        370.00
                    </div>
